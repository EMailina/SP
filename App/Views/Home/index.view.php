...
<main>
    <section class="banner" id="uvod">
        <div class="content">
            <h2>Malina Design</h2>
            <div class="podnadpis">Pretože Dizajn je pre nás Malina</div>
            <a href="?c=about&a=about" class="mbtn">Viac o nás</a>
        </div>
    </section>
    ...
    <section class="about">
        ...
        <div class="photo"></div>
        <p>
            Sme Malina Design - skupina grafických dizajnérov, ktorá sídli v Žiline. Na trhu sme od roku 2020. Počas nášho
            pôsobenia sme získali veľa skúsenosti, iné sme si priniesli z predchádzajúcich jobov a na nové sme pripravený.
    ...
    <section class="portfolio">
        ...
        <a href="?c=portfolio&a=portfolio" class="mbtn stred">Zobraz všetko</a>
    </section>
    ...
    <!--<section class="about">
        ...
        <p>Ahoj, volam sa Erik a som graficky dizajner. Budem ta sprevadzat touto strankou.Ahoj, volam sa Erik a som
            graficky dizajner. Budem ta sprevadzat touto strankou</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Assumenda commodi corporis error, explicabo hic impedit magnam,
            molestias non quaerat quis soluta sunt tenetur, voluptatibus. Ad corporis mollitia odit reiciendis
            voluptatibus!lorem
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci culpa dignissimos incidunt maxime voluptas!
            At cupiditate ducimus, eum expedita, facilis illo inventore itaque molestias mollitia obcaecati quia quibusdam,
            quisquam velit.
        </p>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Assumenda commodi corporis error, explicabo hic impedit magnam,
        ...
        <div class="stred">
            <a href="" class="btn stred">Zisti viac</a>
        </div>
